<!DOCTYPE HTML>
    ...
    <link rel="icon" href="./views/assets/logo.png"/>    
    ...
    <head>
        ...
        <link  href="../views/css/cart.css" rel="stylesheet">
        <link  href="../views/css/itens-cart.css" rel="stylesheet">
        <link  href="../views/css/statusClient.css" rel="stylesheet">
        <link  href="../views/css/styles.css" rel="stylesheet">
        <link  href="../views/css/cart.css" rel="stylesheet">
        <link  href="../views/css/whatsapp.css" rel="stylesheet">
        <link  href="../views/css/cliente.css" rel="stylesheet">
        <script src="../views/js/dist/wow.js"></script>
        <script src="../views/js/dist/wow.min.js"></script> 
    </head>
    ...
    <head>
        ...
        <link  href="../../views/public/css/whatsapp.css" rel="stylesheet">
        <link  href="../../views/public/css/cliente.css" rel="stylesheet">
        <link  href="../../views/public/css/statusClient.css" rel="stylesheet">
